...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='emnext-ui-cache-') as td:
        ...
        try:
            ...
            appjs,_=get(base+'/app.js');apptext=appjs.decode('utf-8');assert 'importMeasurement' in apptext and 'compareMeasurement' in apptext and 'drawMeasurementComparison' in apptext and 'escapeHtml' in apptext
