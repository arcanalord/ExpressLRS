...
async function saveVariant(){
  try{
    ...
    const j=await api('/api/variant/create',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({project:p,variant_id,name,tags:['ui-rev28','ui-rev29']})});
