...
class OverlayView(ctx:Context):View(ctx){
    var frameW=0;var frameH=0;var result=TrackerResult(TrackState.IDLE,null,null,0f,0f,"")
    var onLock:((RectF)->Unit)?=null
    private var quickMode=false
    private var armed=false
    private var down:PointF?=null;private var drag:PointF?=null
