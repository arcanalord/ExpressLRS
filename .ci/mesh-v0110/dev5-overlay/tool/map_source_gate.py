...
required = [
    ...
    ('source_toggle', '_toggleSourceMode', text['map_page']),
    ('online_label', "'Онлайн'", text['map_page']),
    ...
    ('native_source_mode', 'sourceMode()', text['native_view']),
    ('explicit_online_mode', "requestedMode==='online'", text['runtime']),
    ('explicit_offline_error', 'Ошибка офлайн-карты', text['runtime']),
